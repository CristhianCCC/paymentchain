...
public class StandarizedApiExceptionResponse {
    ...
    @Schema(description = "An URI that identifies the error", name="instance", requiredMode = Schema.RequiredMode.REQUIRED,
            example = "/errors/authentication/not-authorized/01")
    private String instance;

    public StandarizedApiExceptionResponse(String code, String detail, String instance, String title, String type) {
        super();
        this.code = code;
        this.detail = detail;
